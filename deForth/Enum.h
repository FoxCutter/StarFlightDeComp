/*
 *  Copyright 2022-2024 Fox Cutter
 *
...
// Format_as for the fmt library TODO: Add version of std::format library 
template<typename EnumType, std::enable_if_t<std::is_enum<EnumType>::value, bool> = true>
auto format_as(EnumType t) 
{ 
	return std::underlying_type_t <EnumType>(t);
}